...
cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='Naresh_it_employee1'")
if not cursor.fetchone():
    ...
    print("Table 'Naresh_it_employee1' created and data inserted.")
else:
    print("Table 'Naresh_it_employee1' already exists. Skipping creation and data insertion.")
